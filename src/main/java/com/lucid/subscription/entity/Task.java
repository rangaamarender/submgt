...
/**
 * @author sgutti
 * @date 01-May-2023 2:54:53 pm
 */
@Entity
@Table(name = Task.TABLE_NAME)
public class Task extends AuditableEntity {
  // --------------------------------------------------------------- Constants
  private static final long serialVersionUID = -1378987402427980394L;
  public static final String TABLE_NAME = "l_task";
  // --------------------------------------------------------- Class Variables
  // ----------------------------------------------------- Static Initializers
  // ------------------------------------------------------ Instance Variables
  @Id
  ...
  @Column(name = "task_desc", nullable = true, length = 500)
