...
import com.lucid.payment.PaymentGatewayRequestType;
import com.lucid.payment.PaymentType;

/**
 * <p>
 * A DTO that is comprised of all the information that is sent to a Payment
 * Gateway to complete a transaction. This DTO uses a modified builder pattern
 * in order to provide an easy way of constructing the request. You can
 * construct a DTO using the following notation:
 * </p>
 * <p>
 * IMPORTANT: note that some of the convenience methods generate a new instance
 * of the object. (e.g. billTo, shipTo, etc...) So, if you need to modify the
 * shipping or billing information after you have invoked
 * requestDTO.shipTo()..., use the getShipTo() method to append more
 * information. Otherwise, you will overwrite the shipping information with a
 * new instance.
 * </p>
 *
 * <pre>
...
public class PaymentRequestDTO {
    ...
    //
    protected String gtwyPymntMethodID;
    protected String gtwyCustomerID;
    protected String gtwyPymntIntentID;
    ...
    /**
     * You should only call this once, as it will create a new customer if
     * called more than once. Use the getter if you need to append more
     * information later.
     */
    ...
    /**
     * You should only call this once, as it will create a new credit card if
     * called more than once. Use the getter if you need to append more
     * information later.
     */
    ...
    /**
     * You should only call this once, as it will create a new subscription if
     * called more than once. Use the getter if you need to append more
     * information later.
     */
     ...
     * if called more than once. Use the getter if you need to append more
     * information later.
     */
    ...
    /**
     * You should only call this once, as it will create a new gift card if
     * called more than once. Use the getter if you need to append more
     * information later.
     */
    public GiftCardDTO<PaymentRequestDTO> giftCard() {
        GiftCardDTO<PaymentRequestDTO> giftCardDTO = new GiftCardDTO<PaymentRequestDTO>(
                this);
    ...
    public CustomerCreditDTO<PaymentRequestDTO> customerCredit() {
        CustomerCreditDTO<PaymentRequestDTO> customerCreditDTO = new CustomerCreditDTO<PaymentRequestDTO>(
                this);
    ...
    public boolean creditCardPopulated() {
        return (getCreditCard() != null && getCreditCard()
                .creditCardPopulated());
    }
    ...
    public boolean subscriptionPopulated() {
        return (getSubscription() != null && getSubscription()
                .subscriptionPopulated());
    }

    /**
     * @return Returns the gtwyPymntMethodID.
     */
    public String getGtwyPymntMethodID() {
        return gtwyPymntMethodID;
    }

    /**
     * @param gtwyPymntMethodID
     *            The gtwyPymntMethodID to set.
     */
    public void gtwyPymntMethodID(String gtwyPymntMethodID) {
        this.gtwyPymntMethodID = gtwyPymntMethodID;
    }
    ...
    /**
     * @param gtwyCustomerID
     *            The gtwyCustomerID to set.
     */
    public void gtwyCustomerID(String gtwyCustomerID) {
        this.gtwyCustomerID = gtwyCustomerID;
    }

    /**
     * @return Returns the gtwyPymntIntentID.
     */
    public String getGtwyPymntIntentID() {
        return gtwyPymntIntentID;
    }

    /**
     * @param gtwyPymntIntentID
     *            The gtwyPymntIntentID to set.
     */
    public void gtwyPymntIntentID(String gtwyPymntIntentID) {
        this.gtwyPymntIntentID = gtwyPymntIntentID;
    }
